...
<!--      </el-upload>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="hospitalizationDate" label="入院日期"></el-table-column>
      <el-table-column prop="infectionSource" label="感染来源"></el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="感染来源">
          <el-input v-model="form.infectionSource" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(`http://${serverIp}:9090/patient/export/diagnose`,
      )
    },
